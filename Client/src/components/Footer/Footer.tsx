...
import { Box, Flex, Heading, Text, Link, Input, InputGroup, InputRightElement, IconButton } from '@chakra-ui/react';
      ...
      <Flex className="footer-container" maxW="1200px" mx="auto" flexWrap="wrap" justifyContent="space-between">
        ...
        <Box mb={6}>
          ...
          <InputGroup>
            ...
            <InputRightElement>
              <IconButton aria-label="Subscribe" icon={<MdEmail />} colorScheme="blue" />
            </InputRightElement>
          </InputGroup>
        </Box>
      </Flex>
